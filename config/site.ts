...
export const perguntasAprofundadas = [
  ...
  {
    id: "identidade",
    pergunta: "Quando você usa perfume, o que você quer sentir?",
    tipo: "multipla",
    opcoes: [
      { valor: "confiante",    texto: "Confiante e pronto para qualquer coisa" },
      { valor: "sedutor",      texto: "Sedutor e presente na memória de quem encontrar" },
      { valor: "acolhido",     texto: "Acolhido, como se estivesse em casa" },
      { valor: "livre",        texto: "Livre e desapegado, sem precisar agradar" },
      { valor: "sofisticado",  texto: "Sofisticado sem precisar mostrar" },
      { valor: "autentico",    texto: "Autêntico, algo que é só meu" },
      { valor: "energizado",   texto: "Energizado e focado" },
      { valor: "misterioso",   texto: "Misterioso, que desperta curiosidade" },
    ],
  },
]
